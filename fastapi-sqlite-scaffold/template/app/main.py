...
# Renders templates/index.html with shared_assets_base baked in server-side
...
# before the StaticFiles mount below so it takes priority over any
# static/index.html that might still exist on disk.
